...
import "./App.css";
const StoriesLazy = React.lazy(() => import("next-stories"));
const WithSeeMore = React.lazy(() =>
  import("next-stories").then((module) => ({
  ...
  return (
    <div className="App">
      <div className="left">
        <h2>
          <code>
            <a
              ...
              href="https://www.npmjs.com/package/next-stories"
              target="_blank"
            >
              next-stories
            </a>
            <br />
            <a href="https://www.npmjs.com/package/next-stories">
              <img
                alt="NPM"
                src="https://img.shields.io/npm/v/next-stories.svg"
              />
            </a>
          </code>
        </h2>
        ...
        <p>
          <a href="https://github.com/Prajata22/next-stories#next-stories">
            Documentation →
          </a>
        </p>
        <p>
          ...
          <a
            rel="noopener noreferrer"
            href="https://github.com/Prajata22/next-stories"
            target="_blank"
          >
            @Prajata22
          </a>
        ...
        <div className="updates">
          ...
          <p>
            ...
            <a href="https://github.com/Prajata22/next-stories/issues/214">
              #214 and others
            </a>
            )
          </p>
          ...
          <p>
            ...
            <a href="https://github.com/Prajata22/next-stories/issues/51">
              #51 and others
            </a>
            )
          </p>
          ...
          <p>
            1. Bug fixes (
            <a href="https://github.com/Prajata22/next-stories/issues/130">
              #130
            </a>
            )
          </p>
          ...
          <p>5. Bug fixes</p>
          <p>
            <a href="https://github.com/Prajata22/next-stories/pull/80">
              Read more here →
            </a>
          </p>
          <br></br>
